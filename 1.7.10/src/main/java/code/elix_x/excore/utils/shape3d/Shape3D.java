...
public abstract class Shape3D {
	...
	public boolean isInside(World world, Entity entity){
		return entity.boundingBox != null ? isInside(world, new AxisAlignedBox(entity.boundingBox)) : isInside(world, Vec3.createVectorHelper(entity.posX, entity.posY, entity.posZ));
	}

	public boolean intersectsWith(World world, Entity entity){
		return entity.boundingBox != null ? intersectsWith(world, new AxisAlignedBox(entity.boundingBox)) : isInside(world, Vec3.createVectorHelper(entity.posX, entity.posY, entity.posZ));
	}
