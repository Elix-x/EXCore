...
public class PerspectiveHelper {
	...
	private static final ReflectionHelper.AMethod<EntityRenderer, Float> getFOVModifier = new ReflectionHelper.AClass<>(EntityRenderer.class).<Float>getDeclaredMethod(new String[]{"getFOVModifier", "func_78481_a"}, float.class, boolean.class).setAccessible(true);

	public static float getFOVModifier(EntityRenderer entityRenderer, float partialTicks, boolean useFOVSetting){
		return getFOVModifier.invoke(entityRenderer, partialTicks, useFOVSetting);
	}
