...
public class IntegralLogorithmicSliderGuiElement<H extends IGuiElementsHandler<? extends IGuiElement<H>>> extends RectangularGuiElement<H> {
	...
	public IntegralLogorithmicSliderGuiElement(String name, int xPos, int yPos, int width, int height, int borderX, int borderY, int sliderWidth, int min, int max, int defaultValue, boolean displayValue){
	...
	public int getValue(){
		...
		double maxv = Math.log(max);
		double scale = maxv - minv;
		return (int) Math.exp(minv + scale * value);
	}
